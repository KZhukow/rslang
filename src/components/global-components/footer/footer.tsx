    ...
    <footer className="footer">
      <div className="footer_container">
        <a className="footer_item" href="https://rs.school/js/" target="_blank" rel="noreferrer">
          <img className="footer_item_img" src="https://react-rslang-back-app.onrender.com/files/img/rssLogo.png" alt="RS School" />
        </a>
        ...
        <div className="footer_link">
          <a className="github_link" href="https://github.com/KZhukow" target="_blank" rel="noreferrer">
            <img className="footer_item_img github_logo" src="https://react-rslang-back-app.onrender.com/files/img/KZhukow.png" alt="GitHub KZhukow" />
          </a>
          <a className="github_link" href="https://github.com/Mikkumo" target="_blank" rel="noreferrer">
            <img className="footer_item_img github_logo" src="https://react-rslang-back-app.onrender.com/files/img/Mikkumo.png" alt="GitHub Mikkumo" />
          </a>
          <a className="github_link" href="https://github.com/yamarauder" target="_blank" rel="noreferrer">
            <img className="footer_item_img github_logo" src="https://react-rslang-back-app.onrender.com/files/img/yamarauder.png" alt="GitHub Yamarauder" />
          </a>
        </div>
      </div>
    </footer>
