...
import { svgAmoutWord0, svgAmoutWord1, svgAmoutWord2, svgAmoutWord3, svgAmoutWord4, svgAmoutWord5, svgAmoutWord6, svgAmoutWord7, svgAmoutWord8, svgAmoutWord9, wordsPage } from './const/const';
